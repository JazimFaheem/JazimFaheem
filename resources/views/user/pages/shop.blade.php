                    ...
                    <div class="mb-8 border border-width-2 border-color-3 borders-radius-6">
                        ...
                        <ul id="sidebarNav" class="list-unstyled mb-0 sidebar-navbar">
                            @foreach ($categories as $categoryItem)
                                <li>
                                    <a class="dropdown-current"
                                        href="{{ route('products.by.category', $categoryItem->slug) }}">{{ $categoryItem->name }}
                                        <span class="text-gray-25 font-size-12 font-weight-normal"></span></a>

                                    <ul class="list-unstyled dropdown-list">
                                        <!-- Menu List -->
                                        @foreach ($categoryItem->subcategory as $subcategoryItem)
                                            <li><a class="dropdown-item"
                                                    href="{{ route('products.by.subcategory', $subcategoryItem->slug) }}">{{ $subcategoryItem->name }}<span
