                                    ...
                                    <div class="mt-1">
                                        ...
                                        <div class="collapse mb-3" id="collapseExample">
                                            <div class="form-group mb-4">
                                                <div class="dropdown bootstrap-select js-select dropdown-select right-dropdown-0-all w-100"><select class="js-select selectpicker dropdown-select right-dropdown-0-all w-100" data-style="bg-white font-weight-normal border border-color-1 text-gray-20" tabindex="-98">
                                                ...
                                                </select><button type="button" class="btn dropdown-toggle bs-placeholder bg-white font-weight-normal border border-color-1 text-gray-20" data-toggle="dropdown" role="button" title="Select a country…"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Select a country…</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
                                            </div>
                                            <div class="form-group mb-4">
                                                <div class="dropdown bootstrap-select js-select dropdown-select right-dropdown-0-all w-100"><select class="js-select selectpicker dropdown-select right-dropdown-0-all w-100" data-style="bg-white font-weight-normal border border-color-1 text-gray-20" tabindex="-98">
                                                ...
                                                </select><button type="button" class="btn dropdown-toggle bs-placeholder bg-white font-weight-normal border border-color-1 text-gray-20" data-toggle="dropdown" role="button" title="Select an option…"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner">Select an option…</div></div> </div></button><div class="dropdown-menu " role="combobox"><div class="inner show" role="listbox" aria-expanded="false" tabindex="-1"><ul class="dropdown-menu inner show"></ul></div></div></div>
                                            </div>
