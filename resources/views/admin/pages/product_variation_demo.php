                                                    ...
                                                    <div id="accordion" class="variation_tab">
                                                        <div class="card card-primary">
                                                                    ...
                                                                    <a class="d-block w-100 collapsed"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            @foreach ($attributes as $attribute)
                                                                                <div class="col-md-3">
                                                                                    <select
                                                                                        name="variations[0][attributes][{{$attribute->id}}][attribute_value_id]"
                                                                                        class="form-control">
                                                                                        <option value="">
                                                            ...
                                                            <div id="variation" class="collapse" data-parent="#accordion"
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="row">
                                                                        <label class="">Variation Image</label>
                                                                        <div class="input-group">
                                                                            <div class="custom-file">
                                                                                <input type="file"
                                                                                    class="custom-file-input"
                                                                                    id="exampleInputFile"
                                                                                    name="variations[0][variations_product_image]">
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="inputProductTitle" placeholder=""
                                                                                name="variations[0][variations_regular_price]">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-4">
                                                                        <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="inputProductTitle" placeholder=""
                                                                                name="variations[0][variations_sale_price]">
                                                                            <p><a href="javascript:;"
                                                                                    class="schedulebtn"><u>schedule</u></a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="schedule" style="display: none">
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input type="date" class="form-control"
                                                                                    id="inputProductTitle" placeholder=""
                                                                                    name="variations[0][variations_start_date]">
                                                                                <p><a href="javascript:;"
                                                                                        class="cancelschedule"><u>cancel</u></a>
                                                                                </p>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <label for="inputProductTitle"
                                                                                ...
                                                                                <input type="date" class="form-control"
                                                                                    id="inputProductTitle" placeholder=""
                                                                                    name="variations[0][variations_end_date]">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="sku" placeholder=""
                                                                                name="variations[0][variations_sku]">
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input
                                                                                    class="form-check-input is_stock_manage"
                                                                                    type="checkbox" value=""
                                                                                    id="stockmanage"
                                                                                    name="variations[0][variations_stock_manage]">
                                                                                <label class="form-check-label"
                                                                                    for="stockmanage">Track
                                                                                    stock quantity for this product</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="stockqty" style="display:none">
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="number" class="form-control"
                                                                                    ...
                                                                                    name="variations[0][variations_quantity]">
                                                                            </div>
                                                                            <div class="col md 2">
                                                                                <p class="help" data-toggle="tooltip"
                                                                                    data-placement="right" title=""
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="radio"
                                                                                        name="variations[0][variations_allow_backorders]"
                                                                                        id="dontallow" value="0">
                                                                                    <label class="form-check-label"
                                                                                        for="dontallow">Do not
                                                                                        allow</label>
                                                                                </div>
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            <div class="col-md-4">
                                                                                <label for="threshold"
                                                                                    class="form-label">Low stock
                                                                                    threshold</label>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <input type="number" class="form-control"
                                                                                    id="threshold" placeholder=""
                                                                                    name="variations[0][variations_low_stock_threshold]">
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <p class="help" data-toggle="tooltip"
                                                                                    data-placement="right" title=""
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="radio"
                                                                                        name="variations[0][variations_stock_status]"
                                                                                        id="instock" value="0">
                                                                                    <label class="form-check-label"
                                                                                        for="instock">In
                                                                                        Stock</label>
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        <div class="col-md-4">
                                                                            <label for="soldindividually"
                                                                                class="form-label">Sold
                                                                                individually</label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input"
                                                                                    ...
                                                                                    id="soldindividually"
                                                                                    name="variations[0][variations_sold_individually]">
                                                                                <label class="form-check-label"
                                                                                    for="soldindividually">Limit
                                                                                    purchases to 1 item per
                                                                                    order</label>
                                                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                name="variations[0][variations_weight]">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            ...
                                                                                            id="length"
                                                                                            placeholder="Length"
                                                                                            name="variations[0][variations_length]">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="width"
                                                                                            placeholder="Width"
                                                                                            name="variations[0][variations_width]">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="height"
                                                                                            placeholder="Height"
                                                                                            name="variations[0][variations_height]">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                ...
                                @foreach ($categories as $category)
                                    ...
                                    @foreach ($sub_categories as $sub_category)
                                        <div class="form-check" style="margin-left:13px">
                                            <input class="form-check-input" name="sub_category_ids[]" type="checkbox"
                                                                        ...
                                                                        <div class="row">
                                                                            @foreach ($attributes as $attribute)
                                                                             ...
                                                                             <div class="col-md-3">
                                                                                ...
                                                                                <select name="variations[` + variation_no + `][attributes][{{$attribute->id}}][attribute_value_id]" class="form-control" >
                                                                                    <option value="">{{ $attribute->name }}</option>
                                                                                    @foreach ($attribute->values as $value)
                                                                                        <option value="{{ $value->id }}" data-attribute-id="{{ $attribute->id }}">
                                                                                            {{ $value->value }}
                                                                                        </option>
                                                                                    @endforeach
                                                                                </select>
                                                                         ...
                                                                         <a href="javascript:;" id="remove_variation" style="color:red;font-size:14px;float:right"><u>Remove</u></a>
                                                                    </a>
                                                                </h4>
                                                            </div>
                                                                ...
                                                                <div class="card-body">
                                                                        ...
                                                                        <div class="input-group">
                                                                            <div class="custom-file">
                                                                                <input type="file"
                                                                                    class="custom-file-input"
                                                                                    id="exampleInputFile"
                                                                                    name="variations[` + variation_no + `][variations_product_image]">
                                                                                <label class="custom-file-label"
                                                                                    for="exampleInputFile">Choose
                                                                                    file</label>
                                                                            </div>
                                                                    ...
                                                                    <div class="row mt-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="inputProductTitle" placeholder=""
                                                                                name="variations[` + variation_no + `][variations_regular_price]">
                                                                        </div>
                                                                    </div>
                                                                    <div class="row mt-4">
                                                                        <div class="col-md-4">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="inputProductTitle" placeholder=""
                                                                                name="variations[` + variation_no + `][variations_sale_price]">
                                                                            <p><a href="javascript:;"
                                                                                    class="schedulebtn"><u>schedule</u></a>
                                                                            </p>
                                                                        </div>
                                                                    ...
                                                                    <div class="schedule" style="display: none">
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input type="date" class="form-control"
                                                                                    id="inputProductTitle" placeholder=""
                                                                                    name="variations[` + variation_no + `][variations_start_date]">
                                                                                <p><a href="javascript:;"
                                                                                        class="cancelschedule"><u>cancel</u></a>
                                                                                </p>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                ...
                                                                                <input type="date" class="form-control"
                                                                                    id="inputProductTitle" placeholder=""
                                                                                    name="variations[` + variation_no + `][variations_end_date]">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="sku" placeholder=""
                                                                                name="variations[` + variation_no + `][variations_sku]">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="form-check">
                                                                                <input
                                                                                    ...
                                                                                    type="checkbox" value=""
                                                                                    id="stockmanage"
                                                                                    name="variations[` + variation_no + `][variations_stock_manage]">
                                                                                <label class="form-check-label"
                                                                                    for="stockmanage">Track
                                                                                    stock quantity for this product</label>
                                                                            </div>
                                                                    ...
                                                                    <div class="stockqty" style="display:none">
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="number" class="form-control"
                                                                                    id="quantity" placeholder=""
                                                                                    name="variations[` + variation_no + `][variations_quantity]">
                                                                            </div>
                                                                            <div class="col md 2">
                                                                                <p class="help" data-toggle="tooltip"
                                                                                    data-placement="right" title=""
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="radio"
                                                                                        name="variations[` + variation_no + `][variations_allow_backorders]"
                                                                                        id="dontallow" value="0">
                                                                                    <label class="form-check-label"
                                                                                        for="dontallow">Do not
                                                                                        allow</label>
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="number" class="form-control"
                                                                                    id="threshold" placeholder=""
                                                                                    name="variations[` + variation_no + `][variations_low_stock_threshold]">
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <p class="help" data-toggle="tooltip"
                                                                                    data-placement="right" title=""
                                                                        ...
                                                                        <div class="row mt-4">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="radio"
                                                                                        name="variations[` + variation_no + `][variations_stock_status]"
                                                                                        id="instock" value="0">
                                                                                    <label class="form-check-label"
                                                                                        for="instock">In
                                                                                        Stock</label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <div class="form-check">
                                                                                <input class="form-check-input"
                                                                                    type="checkbox" value="no"
                                                                                    id="soldindividually"
                                                                                    name="variations[` + variation_no + `][variations_sold_individually]">
                                                                                <label class="form-check-label"
                                                                                    for="soldindividually">Limit
                                                                                    purchases to 1 item per
                                                                                    order</label>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                id="weight" placeholder=""
                                                                                name="variations[` + variation_no + `][variations_weight]">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            ...
                                                                                            id="length"
                                                                                            placeholder="Length"
                                                                                            name="variations[` + variation_no + `][variations_length]">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="width"
                                                                                            placeholder="Width"
                                                                                            name="variations[` + variation_no + `][variations_width]">
                                                                                    </div>
                                                                                    <div class="col-md-4">
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="height"
                                                                                            placeholder="Height"
                                                                                            name="variations[` + variation_no + `][variations_height]">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
