                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        placeholder="Enter Category Name" name="name" value="{{ $subcategory->name }}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Sub-Category Description</label>
                                    <textarea name="description" id="" placeholder="Enter Category Description" class="form-control">{{ $subcategory->description }}</textarea>
                                </div>
                                <div class="form-group">
